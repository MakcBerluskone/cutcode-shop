            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                ...
                @auth
                    <div x-data="{dropdownProfile: false}" class="profile relative">
                        ...
                        <button @click="dropdownProfile = ! dropdownProfile"
                            ...
                            <svg class="shrink-0 w-3 h-3 ml-2" xmlns="http://www.w3.org/2000/svg"
                                 fill="currentColor" viewBox="0 0 30 16">
                        ...
                        >
                            ...
                            <div class="flex items-center mt-3">
                                <img src="{{ auth()->user()->avatar }}"
                                     class="w-11 h-11 rounded-full" alt="Данил Шуцкий">
                ...
                @elseguest
                    <a href="{{ route('login') }}" class="profile hidden xs:flex items-center">
                        <svg class="profile-icon w-8 h-8 text-purple"
                ...
                <a href="{{ route('cart') }}" class="flex items-center gap-3 text-pink hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 md:w-7 w-6 md:h-7"
                ...
                <button id="burgerMenu"
                        class="flex 2xl:hidden text-white hover:text-pink transition">
